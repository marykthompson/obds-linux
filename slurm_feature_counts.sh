...
featureCounts -p --countReadPairs -s 2 -T 8 -t exon -g gene_id -a /project/bioc1402/linux/2_rnaseq/2_genome/Mus_musculus.GRCm38.102.gtf.gz \
       	-o counts3.txt sorted_aln-pe.bam
